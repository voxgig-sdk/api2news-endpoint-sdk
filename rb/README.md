...
The Ruby SDK for the Api2newsEndpoint API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.Api2newsEndpoint(nil).load(
  { "id" => "test01" }, nil
)
