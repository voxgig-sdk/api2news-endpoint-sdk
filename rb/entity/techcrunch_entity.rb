...
class TechcrunchEntity
  ...
  def make
    opts = @_entopts.dup
    TechcrunchEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [TechcrunchListMatch, Hash, nil] match filter (any subset of
  #   Techcrunch fields); defaults to nil, treated as an empty match that lists all.
