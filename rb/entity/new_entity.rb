...
class NewEntity
  ...
  #
  # @param reqmatch [NewListMatch, Hash, nil] match filter (any subset of
  #   New fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<New>, Array] the matching New items; raises Api2newsEndpointError on failure
