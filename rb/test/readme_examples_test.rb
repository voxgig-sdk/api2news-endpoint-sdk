...
#      offline in seeded test mode (Api2newsEndpointSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Api2newsEndpoint_sdk.rb")
  SDK_CLASS = "Api2newsEndpointSDK"
