...
class Api2newsEndpointSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = Api2newsEndpointHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = Api2newsEndpointHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, Api2newsEndpointFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    Api2newsEndpointUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    params = Api2newsEndpointHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = Api2newsEndpointHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = Api2newsEndpointHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = Api2newsEndpointError.new(
        "graphql_error", "Api2newsEndpointSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = Api2newsEndpointSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
