...
The PHP SDK for the Api2newsEndpoint API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Bbc(null)->list(null, null);
...
[$result, $err] = $client->Api2newsEndpoint(null)->load(
    ["id" => "test01"], null
);
