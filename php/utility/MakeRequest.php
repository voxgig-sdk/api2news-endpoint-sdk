...
// Api2newsEndpoint SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Api2newsEndpointMakeRequest
{
    public static function call(Api2newsEndpointContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Api2newsEndpointResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Api2newsEndpointResponse($fetched);
        } else {
