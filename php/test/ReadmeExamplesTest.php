...
// Api2newsEndpoint SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Api2newsEndpointSDK::test)
...
{
    private const SDK_CLASS = 'Api2newsEndpointSDK';
    ...
    private const SDK_BASE = 'api2newsendpoint_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../api2newsendpoint_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
