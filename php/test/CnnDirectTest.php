...
class CnnDirectTest extends TestCase
{
    public function test_direct_list_cnn(): void
    {
        $setup = cnn_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cnn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
