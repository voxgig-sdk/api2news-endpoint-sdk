...
// Api2newsEndpoint SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = Api2newsEndpointOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(Api2newsEndpointOmni::structfix($now, Struct::undef()))
                        !== json_encode(Api2newsEndpointOmni::structfix($val, Struct::undef()))) {
