...
class NewDirectTest extends TestCase
{
    public function test_direct_list_new(): void
    {
        $setup = new_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-new", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
