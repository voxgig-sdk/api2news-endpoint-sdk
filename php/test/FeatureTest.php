...
// Api2newsEndpoint SDK feature test
//
...
class FtCtrl extends Api2newsEndpointControl
{
...
class FtClient
{
    ...
    private Api2newsEndpointUtility $utility;

    public function __construct(Api2newsEndpointUtility $utility, array $options)
    {
    ...
    public function get_utility(): Api2newsEndpointUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (Api2newsEndpointContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public Api2newsEndpointContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (Api2newsEndpointContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = Api2newsEndpointConfig::make_feature($name);
    ...
    private static function buildUrl(Api2newsEndpointSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof Api2newsEndpointError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new Api2newsEndpointResponse($fetched);
        }
    ...
    private function fail(Api2newsEndpointContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (Api2newsEndpointContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
