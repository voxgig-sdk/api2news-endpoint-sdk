...
class BbcDirectTest extends TestCase
{
    public function test_direct_list_bbc(): void
    {
        $setup = bbc_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-bbc", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
