...
class TechcrunchDirectTest extends TestCase
{
    public function test_direct_list_techcrunch(): void
    {
        $setup = techcrunch_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-techcrunch", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
