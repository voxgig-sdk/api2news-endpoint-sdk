...
class Api2newsEndpointSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = Api2newsEndpointHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = Api2newsEndpointHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!Api2newsEndpointFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, Api2newsEndpointFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return Api2newsEndpointUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = Api2newsEndpointHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = Api2newsEndpointHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = Api2newsEndpointHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new Api2newsEndpointError($op . "_allow",
                "Api2newsEndpointSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = Api2newsEndpointHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new Api2newsEndpointError("graphql_error",
                "Api2newsEndpointSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Bbc($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_bbc === null) {
                $this->_bbc = new BbcEntity($this, null);
            }
            return $this->_bbc;
        }
        return new BbcEntity($this, $data);
    }
    ...
    public function Cnn($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_cnn === null) {
                $this->_cnn = new CnnEntity($this, null);
            }
            return $this->_cnn;
        }
        return new CnnEntity($this, $data);
    }
    ...
    public function Techcrunch($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_techcrunch === null) {
                $this->_techcrunch = new TechcrunchEntity($this, null);
            }
            return $this->_techcrunch;
        }
        return new TechcrunchEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new Api2newsEndpointSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
