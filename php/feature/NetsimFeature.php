...
// Api2newsEndpoint SDK netsim feature
...
class Api2newsEndpointNetsimFeature extends Api2newsEndpointBaseFeature
{
    ...
    private function _simulate(Api2newsEndpointContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Api2newsEndpointContext $ctx, array $applied): void
    {
        $client = $this->client;
