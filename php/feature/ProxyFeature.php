...
// Api2newsEndpoint SDK proxy feature
...
class Api2newsEndpointProxyFeature extends Api2newsEndpointBaseFeature
{
    ...
    public function init(Api2newsEndpointContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Api2newsEndpointContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
