...
// Api2newsEndpoint SDK clienttrack feature
...
class Api2newsEndpointClienttrackFeature extends Api2newsEndpointBaseFeature
{
    ...
    public function PostConstruct(Api2newsEndpointContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Api2newsEndpoint-SDK';
