...
// Api2newsEndpoint SDK audit feature
...
class Api2newsEndpointAuditFeature extends Api2newsEndpointBaseFeature
{
    ...
    private function _emit(Api2newsEndpointContext $ctx, string $outcome): void
    {
