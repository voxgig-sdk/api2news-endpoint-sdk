...
// Api2newsEndpoint SDK timeout feature
...
class Api2newsEndpointTimeoutFeature extends Api2newsEndpointBaseFeature
{
    ...
    private function _with_timeout(Api2newsEndpointContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Api2newsEndpointContext $_ctx, float $ms): void
    {
        $client = $this->client;
