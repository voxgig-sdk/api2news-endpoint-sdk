...
// Api2newsEndpoint SDK retry feature
...
class Api2newsEndpointRetryFeature extends Api2newsEndpointBaseFeature
{
    ...
    public function init(Api2newsEndpointContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Api2newsEndpointContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(Api2newsEndpointContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(Api2newsEndpointContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
