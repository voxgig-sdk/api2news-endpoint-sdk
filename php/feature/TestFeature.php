...
// Api2newsEndpoint SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Api2newsEndpointTestFeature extends Api2newsEndpointBaseFeature
{
    ...
    public function init(Api2newsEndpointContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Api2newsEndpointContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = Api2newsEndpointParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Api2newsEndpointContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Api2newsEndpointContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = Api2newsEndpointParam::call($ctx, $k);
