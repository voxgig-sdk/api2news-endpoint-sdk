...
describe("CnnDirect", function()
  it("should direct-list-cnn", function()
    local setup = cnn_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cnn", setup.live and "live" or "unit")
...
function cnn_direct_setup(mockres)
