...
describe("BbcDirect", function()
  it("should direct-list-bbc", function()
    local setup = bbc_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-bbc", setup.live and "live" or "unit")
...
function bbc_direct_setup(mockres)
