...
describe("NewDirect", function()
  it("should direct-list-new", function()
    local setup = new_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-new", setup.live and "live" or "unit")
...
function new_direct_setup(mockres)
