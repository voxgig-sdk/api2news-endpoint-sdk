...
local SDK_MODULE = "api2news-endpoint_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["bbc"] = { ["test01"] = { id = "test01" } }, ["cnn"] = { ["test01"] = { id = "test01" } }, ["new"] = { ["test01"] = { id = "test01" } }, ["techcrunch"] = { ["test01"] = { id = "test01" } } } }'
