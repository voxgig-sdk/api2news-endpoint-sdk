...
describe("TechcrunchDirect", function()
  it("should direct-list-techcrunch", function()
    local setup = techcrunch_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-techcrunch", setup.live and "live" or "unit")
...
function techcrunch_direct_setup(mockres)
