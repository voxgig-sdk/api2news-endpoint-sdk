...
type Args struct {
	Entity string         `json:"entity" jsonschema:"bbc | cnn | new | techcrunch"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.Api2newsEndpointSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "api2news-endpoint_list",
		Description: "List records from Api2newsEndpoint. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "api2news-endpoint_load",
		Description: "Load a single record from Api2newsEndpoint. " +
...
func runOp(client *sdk.Api2newsEndpointSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.Api2newsEndpointSDK, name string) (sdk.Api2newsEndpointEntity, error) {
	switch strings.ToLower(name) {
	case "bbc":
		return client.Bbc(nil), nil
	case "cnn":
		return client.Cnn(nil), nil
	case "new":
		return client.New(nil), nil
	case "techcrunch":
		return client.Techcrunch(nil), nil
