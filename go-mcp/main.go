// Command Api2newsEndpoint-mcp is an MCP server exposing the Api2newsEndpoint
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Api2newsEndpoint_list  — list records of an entity
//	Api2newsEndpoint_load  — load a single record of an entity
//
