...
class TestBbcDirect:
    ...
    def test_should_direct_list_bbc(self):
        setup = _bbc_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-bbc", "live" if setup["live"] else "unit")
        if _skip:
