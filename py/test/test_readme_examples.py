# Api2newsEndpoint SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Api2newsEndpointSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Api2newsEndpointSDK(...) and Api2newsEndpointSDK.test(...) become
#      Api2newsEndpointSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "api2newsendpoint_sdk"
_SDK_CLASS = "Api2newsEndpointSDK"
