# Api2newsEndpoint SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from api2newsendpoint_sdk import Api2newsEndpointSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"Api2newsEndpointSDK": Api2newsEndpointSDK, "os": os}
        try:
