...
from api2newsendpoint_sdk.core.response import Api2newsEndpointResponse
from api2newsendpoint_sdk.core.operation import Api2newsEndpointOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return Api2newsEndpointError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except Api2newsEndpointError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = Api2newsEndpointResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = Api2newsEndpointSDK.test(None, None)
        ...
        class TestInitFeature(Api2newsEndpointBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(Api2newsEndpointBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = Api2newsEndpointSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = Api2newsEndpointSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = Api2newsEndpointSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = Api2newsEndpointSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = Api2newsEndpointOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = Api2newsEndpointSDK.test(None, setup_opts)
