...
from api2newsendpoint_sdk.core.helpers import get_ctx_prop, to_map
...
class Api2newsEndpointContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = Api2newsEndpointControl()
        ...
        if isinstance(sp, Api2newsEndpointSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, Api2newsEndpointResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, Api2newsEndpointResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return Api2newsEndpointOperation({})
    ...
    def make_error(self, code, msg):
        return Api2newsEndpointError(code, msg, self)
