...
from api2newsendpoint_sdk.utility import register

# Load features
from api2newsendpoint_sdk.feature.base_feature import Api2newsEndpointBaseFeature
from api2newsendpoint_sdk.features import _has_feature, _make_feature
...
class Api2newsEndpointSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = Api2newsEndpointUtility()
    ...
    def get_utility(self):
        return Api2newsEndpointUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("Api2newsEndpointSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Techcrunch(self, data=None) -> "TechcrunchEntity":
        ...
        from api2newsendpoint_sdk.entity.techcrunch_entity import TechcrunchEntity
