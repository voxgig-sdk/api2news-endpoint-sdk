...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.API2NEWSENDPOINT_TEST_LIVE ||
    'TRUE' === process.env.API2NEWSENDPOINT_TEST_OVERRIDE
  ) {
  ...
  m.API2NEWSENDPOINT_TEST_EXPLAIN = process.env.API2NEWSENDPOINT_TEST_EXPLAIN || m.API2NEWSENDPOINT_TEST_EXPLAIN
