...
function envOverride(m) {
    if ('TRUE' === process.env.API2NEWS_ENDPOINT_TEST_LIVE ||
        'TRUE' === process.env.API2NEWS_ENDPOINT_TEST_OVERRIDE) {
    ...
    m.API2NEWS_ENDPOINT_TEST_EXPLAIN = process.env.API2NEWS_ENDPOINT_TEST_EXPLAIN || m.API2NEWS_ENDPOINT_TEST_EXPLAIN;
    return m;
}
