# Api2newsEndpoint TypeScript SDK



The TypeScript SDK for the Api2newsEndpoint API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Bbc()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `Api2newsEndpointSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `Api2newsEndpointSDK.test(testopts?, sdkopts?)` | `Api2newsEndpointSDK` | Create a test-mode client. |
...
| `client` | `client(): Api2newsEndpointSDK` | Return the parent SDK client. |
...
api2news-endpoint/
├── src/
│   ├── Api2newsEndpointSDK.ts        # Main SDK class
