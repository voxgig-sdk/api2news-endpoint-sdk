...
|---|---|---|
| `ts/` | @voxgig-sdk/api2news-endpoint-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/api2news-endpoint-sdk \
      --repository voxgig-sdk/api2news-endpoint-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/api2news-endpoint-sdk` shows it, and
`npm trust revoke @voxgig-sdk/api2news-endpoint-sdk --id=<id>` removes it.
