...
// Api2newsEndpoint SDK rbac feature
...
class Api2newsEndpointRbacFeature extends Api2newsEndpointBaseFeature
{
    ...
    private function _required(Api2newsEndpointContext $ctx): ?string
    {
    ...
    private function _reject(Api2newsEndpointContext $ctx, string $required): void
    {
    ...
    private function _track(Api2newsEndpointContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
