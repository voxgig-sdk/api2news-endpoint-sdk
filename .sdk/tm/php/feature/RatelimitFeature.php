...
// Api2newsEndpoint SDK ratelimit feature
...
class Api2newsEndpointRatelimitFeature extends Api2newsEndpointBaseFeature
{
    ...
    private function _acquire(Api2newsEndpointContext $ctx): void
    {
    ...
    private function _track(Api2newsEndpointContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
