...
// Api2newsEndpoint SDK cache feature
...
class Api2newsEndpointCacheFeature extends Api2newsEndpointBaseFeature
{
    ...
    private function _through(Api2newsEndpointContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
