...
// Api2newsEndpoint SDK utility: graphql
//
...
class Api2newsEndpointGraphql
{
    ...
    // equivalent.
    public static function body(Api2newsEndpointContext $ctx): mixed
    {
    ...
    public static function errors(Api2newsEndpointContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
