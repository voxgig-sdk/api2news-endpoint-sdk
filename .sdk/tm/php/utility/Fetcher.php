...
// Api2newsEndpoint SDK utility: fetcher

class Api2newsEndpointFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Api2newsEndpointSDK/1.0)';
    ...
    public static function call(Api2newsEndpointContext $ctx, string $fullurl, array $fetchdef): array
    {
