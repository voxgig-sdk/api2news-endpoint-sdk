...
// Api2newsEndpoint SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Api2newsEndpointParam
{
    public static function call(Api2newsEndpointContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Api2newsEndpointHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
