...
// Api2newsEndpoint SDK pipeline test
//
...
{
    private static function utility(): Api2newsEndpointUtility
    {
        return new Api2newsEndpointUtility();
    }
    ...
    private static function ctx(array $over = []): Api2newsEndpointContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new Api2newsEndpointContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new Api2newsEndpointOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof Api2newsEndpointError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new Api2newsEndpointOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = Api2newsEndpointMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new Api2newsEndpointOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = Api2newsEndpointMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new Api2newsEndpointOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = Api2newsEndpointMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Api2newsEndpointSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = Api2newsEndpointMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new Api2newsEndpointResponse([]),
            'result' => new Api2newsEndpointResult([]),
        ]);
        [, $err] = Api2newsEndpointMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new Api2newsEndpointSpec([]),
            'response' => null,
            'result' => new Api2newsEndpointResult([]),
        ]);
        [, $err] = Api2newsEndpointMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new Api2newsEndpointSpec(['step' => 's']),
            'response' => new Api2newsEndpointResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new Api2newsEndpointResult([]),
        ]);
        [, $err] = Api2newsEndpointMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new Api2newsEndpointSpec(['step' => 's']),
            'response' => new Api2newsEndpointResponse(self::resp(200, ['v' => 1])),
            'result' => new Api2newsEndpointResult([]),
        ]);
        [, $err] = Api2newsEndpointMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new Api2newsEndpointSpec(['step' => 's']),
            'response' => new Api2newsEndpointResponse(self::resp(200, ['v' => 2])),
            'result' => new Api2newsEndpointResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        Api2newsEndpointMakeResponse::call($ctx);
    ...
    {
        $preset = new Api2newsEndpointResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new Api2newsEndpointSpec([]),
            'response' => new Api2newsEndpointResponse([]),
            'result' => new Api2newsEndpointResult([]),
        ...
        [$got, $err] = Api2newsEndpointMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new Api2newsEndpointResult([])]);
        [, $err] = Api2newsEndpointMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new Api2newsEndpointSpec([]), 'result' => null]);
        [, $err] = Api2newsEndpointMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Api2newsEndpointSpec(['step' => 's']),
            'result' => new Api2newsEndpointResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new Api2newsEndpointOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Api2newsEndpointMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new Api2newsEndpointSpec(['step' => 's']),
            'result' => new Api2newsEndpointResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new Api2newsEndpointOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = Api2newsEndpointMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new Api2newsEndpointResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new Api2newsEndpointSpec([]),
            'result' => new Api2newsEndpointResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = Api2newsEndpointMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Api2newsEndpointMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new Api2newsEndpointError('boom', 'boom');
        $utility->fetcher = function (Api2newsEndpointContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Api2newsEndpointSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = Api2newsEndpointMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (Api2newsEndpointContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = Api2newsEndpointMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(Api2newsEndpointResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        Api2newsEndpointMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (Api2newsEndpointContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new Api2newsEndpointSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = Api2newsEndpointMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new Api2newsEndpointResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new Api2newsEndpointSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = Api2newsEndpointMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = Api2newsEndpointMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = Api2newsEndpointMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new Api2newsEndpointResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, Api2newsEndpointDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new Api2newsEndpointResult(['ok' => false])]);
        $this->expectException(Api2newsEndpointError::class);
        Api2newsEndpointDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new Api2newsEndpointResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', Api2newsEndpointMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        Api2newsEndpointMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new Api2newsEndpointBaseFeature();
        $b = new Api2newsEndpointBaseFeature();
        Api2newsEndpointFeatureAdd::call($ctx, $a);
        Api2newsEndpointFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): Api2newsEndpointBaseFeature
    {
        $f = new Api2newsEndpointBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        Api2newsEndpointFeatureAdd::call($ctx, self::named_feature('a'));
        Api2newsEndpointFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        Api2newsEndpointFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        Api2newsEndpointFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        Api2newsEndpointFeatureAdd::call($ctx, $replace);
        ...
        Api2newsEndpointFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): Api2newsEndpointContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new Api2newsEndpointSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = Api2newsEndpointPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        Api2newsEndpointPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new Api2newsEndpointResponse(['headers' => null]),
            'result' => new Api2newsEndpointResult([]),
        ]);
        Api2newsEndpointResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        Api2newsEndpointResultBody::call($ctx);
