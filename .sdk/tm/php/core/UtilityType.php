...
// Api2newsEndpoint SDK utility type

class Api2newsEndpointUtility
{
    ...
    public static function copy(Api2newsEndpointUtility $src): Api2newsEndpointUtility
    {
        $u = new Api2newsEndpointUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
