...
local function make_error_util(ctx, err)
  ...
  local msg = "Api2newsEndpointSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = Api2newsEndpointError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == Api2newsEndpointError then
