...
class Api2newsEndpointTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = Api2newsEndpointTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = Api2newsEndpointTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = Api2newsEndpointTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
