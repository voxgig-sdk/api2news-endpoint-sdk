...
// instead of `sdk.NewApi2newsEndpointSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *Api2newsEndpointSDK  { return NewApi2newsEndpointSDK(nil) }
func Test() *Api2newsEndpointSDK { return TestSDK(nil, nil) }
