...
type Api2newsEndpointSDK struct {
	Mode     string
...
func (sdk *Api2newsEndpointSDK) OptionsMap() map[string]any {
...
func (sdk *Api2newsEndpointSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *Api2newsEndpointSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *Api2newsEndpointSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Api2newsEndpointSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *Api2newsEndpointSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *Api2newsEndpointSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("Api2newsEndpointSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *Api2newsEndpointSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *Api2newsEndpointSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("Api2newsEndpointSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *Api2newsEndpointSDK {
	...
	sdk := NewApi2newsEndpointSDK(sdkopts)
	sdk.Mode = "test"
