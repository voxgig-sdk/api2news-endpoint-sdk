...
const testSeed = `map[string]any{"entity": map[string]any{"bbc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cnn": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "new": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "techcrunch": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
