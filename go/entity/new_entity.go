...
func NewNewEntity(client *core.Api2newsEndpointSDK, entopts map[string]any) *NewEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NewEntity) GetName() string { return e.name }
...
func (e *NewEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NewEntity) Deleted() bool {
	return e.deleted
}


func (e *NewEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNewEntity(e.client, opts)
}

func (e *NewEntity) Data(args ...any) any {
...
func (e *NewEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *NewEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NewEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *NewEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *NewEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NewEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NewEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NewEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
