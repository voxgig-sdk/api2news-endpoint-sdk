...
func NewBbcEntity(client *core.Api2newsEndpointSDK, entopts map[string]any) *BbcEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BbcEntity) GetName() string { return e.name }
...
func (e *BbcEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BbcEntity) Deleted() bool {
	return e.deleted
}


func (e *BbcEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBbcEntity(e.client, opts)
}

func (e *BbcEntity) Data(args ...any) any {
...
func (e *BbcEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bbc; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BbcEntity) DataTyped(data ...Bbc) Bbc {
	if len(data) > 0 {
		return typedFrom[Bbc](e.Data(asMap(data[0])))
	}
	return typedFrom[Bbc](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bbc (all fields
// optional at the wire level).
func (e *BbcEntity) MatchTyped(match ...Bbc) Bbc {
	if len(match) > 0 {
		return typedFrom[Bbc](e.Match(asMap(match[0])))
	}
	return typedFrom[Bbc](e.Match())
}
...
func (e *BbcEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BbcEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BbcEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BbcListMatch and returns []Bbc. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BbcEntity) ListTyped(reqmatch BbcListMatch, ctrl map[string]any) ([]Bbc, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Bbc](res), nil
}



func (e *BbcEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BbcEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BbcEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BbcEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
