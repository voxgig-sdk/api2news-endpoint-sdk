...
func NewCnnEntity(client *core.Api2newsEndpointSDK, entopts map[string]any) *CnnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CnnEntity) GetName() string { return e.name }
...
func (e *CnnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CnnEntity) Deleted() bool {
	return e.deleted
}


func (e *CnnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCnnEntity(e.client, opts)
}

func (e *CnnEntity) Data(args ...any) any {
...
func (e *CnnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cnn; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CnnEntity) DataTyped(data ...Cnn) Cnn {
	if len(data) > 0 {
		return typedFrom[Cnn](e.Data(asMap(data[0])))
	}
	return typedFrom[Cnn](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cnn (all fields
// optional at the wire level).
func (e *CnnEntity) MatchTyped(match ...Cnn) Cnn {
	if len(match) > 0 {
		return typedFrom[Cnn](e.Match(asMap(match[0])))
	}
	return typedFrom[Cnn](e.Match())
}
...
func (e *CnnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CnnEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CnnEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CnnListMatch and returns []Cnn. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CnnEntity) ListTyped(reqmatch CnnListMatch, ctrl map[string]any) ([]Cnn, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cnn](res), nil
}



func (e *CnnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CnnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CnnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CnnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
