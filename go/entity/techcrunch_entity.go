...
import (
	...
	vs "github.com/voxgig-sdk/api2news-endpoint-sdk/go/utility/struct"
)

type TechcrunchEntity struct {
	name    string
	client  *core.Api2newsEndpointSDK
...
func NewTechcrunchEntity(client *core.Api2newsEndpointSDK, entopts map[string]any) *TechcrunchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TechcrunchEntity) GetName() string { return e.name }
...
func (e *TechcrunchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TechcrunchEntity) Deleted() bool {
	return e.deleted
}


func (e *TechcrunchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTechcrunchEntity(e.client, opts)
}

func (e *TechcrunchEntity) Data(args ...any) any {
...
func (e *TechcrunchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Techcrunch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TechcrunchEntity) DataTyped(data ...Techcrunch) Techcrunch {
	if len(data) > 0 {
		return typedFrom[Techcrunch](e.Data(asMap(data[0])))
	}
	return typedFrom[Techcrunch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Techcrunch (all fields
// optional at the wire level).
func (e *TechcrunchEntity) MatchTyped(match ...Techcrunch) Techcrunch {
	if len(match) > 0 {
		return typedFrom[Techcrunch](e.Match(asMap(match[0])))
	}
	return typedFrom[Techcrunch](e.Match())
}
...
func (e *TechcrunchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TechcrunchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TechcrunchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TechcrunchListMatch and returns []Techcrunch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TechcrunchEntity) ListTyped(reqmatch TechcrunchListMatch, ctrl map[string]any) ([]Techcrunch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Techcrunch](res), nil
}



func (e *TechcrunchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TechcrunchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TechcrunchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TechcrunchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
