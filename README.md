...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/api2news-endpoint` | `npm install @voxgig-sdk/api2news-endpoint` |
| Python | `voxgig-sdk-api2news-endpoint` | `pip install voxgig-sdk-api2news-endpoint` |
| PHP | `voxgig-sdk/api2news-endpoint` | `composer require voxgig-sdk/api2news-endpoint` |
| Golang | `github.com/voxgig-sdk/api2news-endpoint-sdk/go` | `go get github.com/voxgig-sdk/api2news-endpoint-sdk/go` |
| Ruby | `voxgig-sdk-api2news-endpoint` | `gem install voxgig-sdk-api2news-endpoint` |
| Lua | `voxgig-sdk-api2news-endpoint` | `luarocks install voxgig-sdk-api2news-endpoint` |
