...
AQL-driven CLI and REPL for the Api2newsEndpoint SDK. Positional arguments are
...
```sh
go build -o api2news-endpoint-cli ./...
```
...
./api2news-endpoint-cli load 1 bbc
./api2news-endpoint-cli load '{id:1}' bbc
