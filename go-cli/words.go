...
func registerSDKWords(r *eng.Registry, client *sdk.Api2newsEndpointSDK) {
...
func runOp(client *sdk.Api2newsEndpointSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
